(function () {
    ...
    //console.log('hello from hacked conversion.js');
    ...
    function createConversionItemParameter(conversionDetails) {
        ...
        //console.log('conversion details: ' + itemDetailsArray.join(""));
    ...
    function createWindowDetailsParameter(globalWindowObj, navigatorObj, gConversionDateObj) {
        ...
        //console.log('window details: ' + parameterArray.join(""));
    ...
    function createConversionPageDetailParameters(globalWindowObj, documentObj, googleConversionPageUrl) {
        ...
        //console.log('conversio page details: ' + parameters);
        return parameters
    }
    ...
    function buildPixelTag() {
        ...
        //console.log('built the output: ' + c);
        ...
        var iframeoranchoroutputvariable = 0 == a.google_conversion_format && a.google_conversion_domain == nullValue
        ...
        console.log(iframeoranchoroutputvariable);

        return iframeoranchoroutputvariable;
    }
    ...
    if (globalWindow)
        if (/[\?&;]google_debug/.exec(document.URL) != nullValue) {
            ...
            try {
				...
				console.log(window.google_conversion_type);
                var A;
                var B = globalWindow;
